  ...
  return (
    ...
    gap-5 border-2 border-black border-solid">
      ...
      <div className="flex gap-5 w-full h-12 m-5">
        ...
        <button className="h-full w-32 border-black uppercase border-2 hover:font-bold
          border-solid rounded-lg active:bg-slate-600 active:text-white"
          onClick={()=>{
            setxoa(!Xoa)
            setthem(false)
      ...
      {Them && (
        <div className="flex flex-col gap-5 h-20 m-5">
          ...
          border-solid rounded-lg active:bg-slate-600 active:text-white">submit</button>
        </div>
      )}
      {Xoa && (
        <div className="flex flex-col gap-5 h-20 m-5">
      ...
      <div style={{ padding: "10px",}}>
        {" "}
        <span style={{ fontWeight: "bold", marginRight:'10px'}}>Department name:</span>
        {el.name}{" "}
      </div>
    </li>
))}
